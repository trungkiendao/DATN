            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <a href="/clientProducts"><button class="btn btn-outline-primary btn-sm btn-block">Continue Shopping</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 pl-5">
                    <div class="row justify-content-end">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='{{ route('checkout') }}'">Đặt hàng</button>
                                </div>
                            </div>
                        </div>
                    </div>
