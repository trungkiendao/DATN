        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-1 topbar-head-dropdown header-item">
                <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                    ...
                    <img id="header-lang-img" src="/admin/assets/images/flags/us.svg"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                        ...
                        <img src="/admin/assets/images/flags/us.svg" alt="user-image"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/spain.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/germany.svg" alt="user-image"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/italy.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/russia.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/china.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/french.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                        ...
                        <img src="/admin/assets/images/flags/ae.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                ...
                <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                    ...
                    <div class="p-2">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="/admin/assets/images/brands/mail_chimp.png"
                                        alt="mail_chimp">
